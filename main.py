...
PAYEER_ACCOUNT = os.getenv("PAYEER_ACCOUNT", "P1062588236")
BOT_USERNAME = os.getenv("BOT_USERNAME", "bestfarlm_bot")
ADMIN_USERNAME = os.getenv("ADMIN_USERNAME", "mominjon_gofurov")
BOT_NAME = os.getenv("BOT_NAME", "BEST FARM 🌱")
...
async def process_top_up_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        extra = (message.from_user.id % 3) + 1
